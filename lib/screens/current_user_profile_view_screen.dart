...
class _CurrentUserProfileViewScreenState
  ...
  final dummyProfile = Profile(
      ...
      location:
          '${SettingsData.instance.longitude},${SettingsData.instance.latitude} TODO convert this in server to named location such as Haifa,Israel', //TODO convert this in server to named location such as Haifa,Israel
