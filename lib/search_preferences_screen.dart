...
class SearchPreferencesScreen extends StatefulWidget {
  SearchPreferencesScreen({Key key,MatchEngine matchEngine}) :matchEngine=matchEngine,super(key: key);
  ...
  @override
  _SearchPreferencesScreenState createState() => _SearchPreferencesScreenState();
}
