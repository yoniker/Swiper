  ...
  void updateCelebImages() {
    if (widget.theCeleb.imagesUrls != null) {
      ...
      for (int imageIndex = 0;
          imageIndex < widget.theCeleb.imagesUrls.length;
          imageIndex++) {
        String url = 'http://' +
            NetworkHelper.SERVER_ADDR +
            widget.theCeleb.imagesUrls[imageIndex];
        Image img =
            Image.network(url, height: 150.0, width: 150.0, fit: BoxFit.cover);
